 ...
 * @author zidun
 */
public class admin_trayek extends javax.swing.JFrame {
     public Statement st;
    public ResultSet rs;
    ...
    public void judul(){
        Object[] judul ={"No.","Kode Trayek","Kota Asal","Kota Tujuan","Harga Trayek"};
        tabmodel = new DefaultTableModel(null,judul);
        tbl_trayek.setModel(tabmodel);
    }
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("FORM INPUT TRAYEK BUS");
        ...
        ttujuan.setBackground(new java.awt.Color(85, 153, 142));
        ttujuan.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ttujuan.setForeground(new java.awt.Color(255, 255, 255));
        ttujuan.setBorder(null);
        jPanel1.add(ttujuan, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 290, 320, 30));
        ...
        jScrollPane1.setViewportView(tbl_trayek);
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 190, -1, -1));

        tasal.setBackground(new java.awt.Color(85, 153, 142));
        tasal.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        tasal.setForeground(new java.awt.Color(255, 255, 255));
        tasal.setBorder(null);
        jPanel1.add(tasal, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 220, 320, 30));
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 250, 320, 10));
    ...
    private void tcariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tcariKeyReleased
        ...
        try {
            ...
            tabmodel.getDataVector().removeAllElements();
            tabmodel.fireTableDataChanged();
            rs = st.executeQuery("SELECT * FROM tbl_trayek WHERE asal LIKE '%"+tcari.getText()+"%' OR tujuan LIKE '%"+tcari.getText()+"%' OR harga_trayek LIKE '%"+tcari.getText()+"%'");
            while(rs.next()){
                int b = no++;
                Object[] data = {
                    b,
    ...
    private void tbl_trayekMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_trayekMouseClicked
        // TODO add your handling code here:
        tasal.setText(tabmodel.getValueAt(tbl_trayek.getSelectedRow(), 2)+"");
        ttujuan.setText(tabmodel.getValueAt(tbl_trayek.getSelectedRow(), 3)+"");
        tharga.setText(tabmodel.getValueAt(tbl_trayek.getSelectedRow(), 4)+"");
        tasal.requestFocus();
    ...
    private void bhapusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bhapusMouseClicked
        ...
        if((jawab = JOptionPane.showConfirmDialog(null, "Anda yakin kan menghapus data ini ?","Konfirmasi", JOptionPane.YES_NO_OPTION))==0){
            aksi.hapus("tbl_trayek", "kd_trayek = '"+tabmodel.getValueAt(tbl_trayek.getSelectedRow(), 1)+"'");
            refresh();
//            String sql = "DELETE FROM tbl_trayek WHERE kd_trayek = '"+tabmodel.getValueAt(tbl_trayek.getSelectedRow(), 1)+"'";
//            aksi(sql,"Data Berhasil Dihapus");
    ...
    private void bsimpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bsimpanMouseClicked
        // TODO add your handling code here:
        if ( tasal.getText().isEmpty() || ttujuan.getText().isEmpty() || tharga.getText().isEmpty() || tharga.getText().equals(0)) {
            JOptionPane.showMessageDialog(null, "Lengkapi Data Terleih Dahulu !");
        } else {
            String nama = tasal.getText()+" - "+ttujuan.getText();
            aksi.simpan("tbl_trayek", "null,'"+tasal.getText()+"','"+ttujuan.getText()+"','"+tharga.getText()+"','"+nama+"'");
            refresh();
//            String sql = "INSERT INTO tbl_trayek VALUES(null,'"+tasal.getText()+"','"+ttujuan.getText()+"','"+tharga.getText()+"','"+nama+"')";
//            aksi(sql,"Data Berhasil Disimpan");
    ...
    private void beditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_beditMouseClicked
        ...
        if(tasal.getText().isEmpty() || ttujuan.getText().isEmpty() || tharga.getText().isEmpty() || tharga.getText().equals(0)){
            ...
            String nama = tasal.getText()+" - "+ttujuan.getText();
            aksi.update("tbl_trayek", "asal = '"+tasal.getText()+"', tujuan = '"+ttujuan.getText()+"',  harga_trayek ='"+tharga.getText()+"', nama_trayek = '"+nama+"'", "kd_trayek = '"+tabmodel.getValueAt(tbl_trayek.getSelectedRow(), 1)+"'");
            refresh();
//            String sql = "UPDATE tbl_trayek SET asal = '"+tasal.getText()+"', tujuan = '"+ttujuan.getText()+"',  harga_trayek ='"+tharga.getText()+"', nama_trayek = '"+nama+"' WHERE kd_trayek = '"+tabmodel.getValueAt(tbl_trayek.getSelectedRow(), 1)+""+"'";
//            aksi(sql, "Data Berhasil Diubah");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_trayek.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_trayek().setVisible(true);
            }
        });
    }
