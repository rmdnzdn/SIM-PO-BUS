...
<body>
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="?menu=halagen">A G E N</a>
		</div>
		<!-- akhir dari navbar atas -->
		<div class="navbar-collapse collaspse">
			<ul class="nav navbar-nav" id="hov">
				<li>
					<a href="?menu=daftartiket"><div class="glyphicon glyphicon-plane"></div>&nbsp;&nbsp;Daftar Tiket Perjalanan</a>
				</li>
			</ul>
			<ul class="nav navbar-nav" id="hov">
				<li>
					<a href="?menu=penjualantiket"><div class="glyphicon glyphicon-tags"></div>&nbsp;&nbsp;Penjualan Tiket</a>
				</li>
			</ul>
			<ul class="nav navbar-nav" id="hov">
				<li>
					<a href="?menu=daftarpenjualan"><div class="glyphicon glyphicon-menu-hamburger"></div>&nbsp;&nbsp;Daftar Penjualan Tiket</a>
				</li>
			</ul>
			<ul class="nav navbar-nav" id="hov">
				<li>
					<a href="?menu=profil"><div class="glyphicon glyphicon-user"></div>&nbsp;&nbsp; Profil Anda</a>
				</li>
			</ul>
			<ul class="nav navbar-nav" id="hov">
				<li>
	...
	<?php  
		switch (@$_GET['menu']){
			case 'daftartiket':include 'daftar_tiket.php'; break;	
			case 'halagen':include 'hal_agen.php'; break;	
			case 'penjualantiket':include 'penjualan_tiket.php'; break;	
			case 'daftarpenjualan':include 'daftar_penjualan.php'; break;	
			case 'detail':include 'detail_penjualan.php'; break;	
			case 'profil':include '../direktur/profil.php'; break;	
			default:$aksi->alamat("index.php?menu=halagen");break;
		}
	?>
