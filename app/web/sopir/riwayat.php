 <?php 
	...
	// @$cari="WHERE MONTH(tanggal_perjalanan)='$bulanini' AND YEAR(tanggal_perjalanan)='$tahunini' AND (sopir_1 LIKE '%$sopir[0]%' OR sopir_2 LIKE  '%$sopir[0]%')";
	// switch ($bulanini) {
	...
	@$cari ="WHERE status = 'selesai' AND (sopir_1 LIKE '%$sopir[0]%' OR sopir_2 LIKE  '%$sopir[0]%')";
	...
	<div class="row">
		<div class="panel panel-primary">
			<div class="panel-heading" style="height:40px;">
				<!-- <h3 class="panel-title pull-left">Daftar Riwayat Perjalan - Bulan <?php echo @$bulaninitext." ".@$tahunini ; ?></h3> -->
				<h3 class="panel-title"><center>Daftar Riwayat Perjalanan</center></h3>
			</div>
			<div class="panel-body">
				...
				<div class="table table-responsive">
					<table class="table table-bordered table-hover table-striped">
						...
						<tbody>
							<?php  
								$sql = $aksi->tampil("tbl_perjalanan",$cari,"");
								@$no = 0;
								if ($sql =="") {
							...
							?>
								<tr>
									...
									<td><center><a href="?menu=detail&kd_perjalanan=<?php echo $data[0]; ?>" class="btn btn-primary btn-xs">Detail</a></center></td>
								</tr>
							<?php } } 
							?>
						</tbody>
