<?php
	...
	@$sql = mysql_query("SELECT * FROM tbl_user WHERE $where");
				...
				<form method="post">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="email" name="temail" value="<?php echo $data['email']; ?>" class="form-control" placeholder="Email Anda" required tabindex="0" maxlength="50">
						</div>
					</div>
					<div class="form-group">
						<div class="input-group">
