 <?php 
	...
	@$cari="WHERE MONTH(tanggal_pembelian)='$bulanini' AND YEAR(tanggal_pembelian)='$tahunini'";
	switch ($bulanini) {
	...
	<div class="row">
		<div class="panel panel-primary">
			<div class="panel-heading" style="height:40px;">
				<h3 class="panel-title pull-left">Daftar Pendapatan Keuangan - Bulan <?php echo @$bulaninitext." ".@$tahunini ; ?></h3>
			...
			<div class="panel-body">
				<form method="post">
					<div class="col-md-12" style="margin-left:-30px;margin-bottom:10px;">
						...
						<div class="col-md-4">
							<a href="../direktur/cetak_pendapatan.php?bln=<?php echo $bulanini; ?>&thn=<?php echo $tahunini; ?>" target="_blank" class="btn btn-success"><div class="glyphicon glyphicon-print"></div>&nbsp;Cetak</a>
						</div>
					</div>
					...
					<table class="table table-bordered table-hover table-striped">
						<thead id="pri">
							...
							<th>ID Asal</th>
							<th  width="18%"><center>Pendapatan</center></th>
						</thead>
						<tbody>
							<?php  
							...
							<?php } } 
								@$a = mysql_query("SELECT SUM(total_harga) as 'dapat' FROM tbl_pembelian WHERE MONTH(tanggal_pembelian)='$bulanini' AND YEAR(tanggal_pembelian)='$tahunini'");
								@$b = mysql_fetch_array($a);
							?>
								<tfoot>
									<tr>
										<td colspan="4" align="right"><b>Total Pendapatan :</b></td>
										<td align="right"><b>Rp. <?php echo number_format(@$b['dapat'],0,'','.'); ?></b></td>
									</tr>
								</tfoot>
						</tbody>
					</table>
