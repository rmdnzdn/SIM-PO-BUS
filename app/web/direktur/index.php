...
<body>
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.php">D I R E K T U R</a>
		</div>
		<!-- akhir dari navbar atas -->
		<div class="navbar-collapse collaspse">
			<ul class="nav navbar-nav" id="hov">
				<li>
					<a href="?menu=perjalanan"><div class="glyphicon glyphicon-plane"></div>&nbsp;&nbsp;Laporan Perjalanan BUS</a>
				</li>
			</ul>
			<ul class="nav navbar-nav" id="hov">
				<li>
					<a href="?menu=pendapatan"><div class="glyphicon glyphicon-tags"></div>&nbsp;&nbsp;Laporan Pendapatan Keuangan</a>
				</li>
			</ul>
			<ul class="nav navbar-nav" id="hov">
				<li>
	...
	<?php  
		switch (@$_GET['menu']){
			case 'pendapatan':include 'lap_pendapatan.php'; break;	
			case 'haldirektur':include 'hal_direktur.php'; break;	
			case 'perjalanan':include 'lap_perjalanan.php'; break;	
			case 'profil':include 'profil.php'; break;	
			case 'detailperjalanan':include '../sopir/detail_perjalanan.php'; break;	
			default:$aksi->alamat("index.php?menu=haldirektur");break;
		}
	?>
